...
from .models import ProyeccionTecnologica


@admin.register(ProyeccionTecnologica)
class ActaAdmin(admin.ModelAdmin):
    formfield_overrides = {
        models.JSONField: {"widget": JSONEditorWidget},
    }

    list_display = ("llave_maestra", "estatus", "creado_por", "modificado_por", "creado_en", "actualizado_en")
