...
class ProyeccionTecnologica(models.Model):
    llave_maestra = models.ForeignKey(
        RegistroCalificado,
        to_field="llave_documento",
        on_delete=models.CASCADE,
        related_name="proyeccion_tecnologica",
        null=True,
        blank=True,
    )
    ...
    estatus = models.BooleanField(
        default=False,
        help_text="Indica si proyeccion_tecnologica ha sido validada como correcta"
    )
    ...
    creado_por = models.ForeignKey(
        ...
        null=True,
        blank=True,
        related_name="proyeccion_tecnologica_creadas",
    )
    ...
    modificado_por = models.ForeignKey(
        ...
        null=True,
        blank=True,
        related_name="proyeccion_tecnologica_modificadas",
    )
