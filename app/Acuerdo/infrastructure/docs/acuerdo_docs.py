...
crear_acuerdo_doc = {
    "operation_summary": "Crear un acuerdo de programa (con soporte para Excel)",
    "operation_description": "Crea un acuerdo enviando la estructura JSON y, opcionalmente, un archivo Excel de asignaturas. **Debe usar `multipart/form-data`**.",
    "tags": ["Acuerdo"],
