...
class ProyeccionInfracTecnol(models.Model):
    llave_maestra = models.ForeignKey(
        RegistroCalificado,
        to_field="llave_documento",
        on_delete=models.CASCADE,
        related_name="proyeccion_infrac_tecnol",
        null=True,
        blank=True,
    )
    ...
    estatus = models.BooleanField(
        default=False,
        help_text="Indica si ProyeccionInfracTecnol ha sido validada como correcta"
    )
    ...
    creado_por = models.ForeignKey(
        ...
        null=True,
        blank=True,
        related_name="proyeccion_infrac_tecnol_creadas",
    )
    ...
    modificado_por = models.ForeignKey(
        ...
        null=True,
        blank=True,
        related_name="proyeccion_infrac_tecnol_modificadas",
    )
