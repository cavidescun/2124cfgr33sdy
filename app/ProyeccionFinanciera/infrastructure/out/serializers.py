...
class ProyeccionFinancieraResponseSerializer(serializers.Serializer):
    id = serializers.IntegerField()
    llave_maestra = serializers.CharField()
    creado_en = serializers.DateTimeField()

class ProyeccionFinancieraDetailResponseSerializer(ProyeccionFinancieraResponseSerializer):
...
class  ProyeccionFinancieraUpdateResponseSerializer(serializers.Serializer):
