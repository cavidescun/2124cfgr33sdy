...
class CrearDocumento:
    ...
    def seleccionar_plantilla(self, variables: dict) -> str:
        """
        Retorna la plantilla correcta según nivel y ciclo o tipo_programa,
        siguiendo EXACTAMENTE la estructura existente en /application/documents.
        """
